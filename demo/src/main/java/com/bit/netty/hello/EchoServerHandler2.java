...
public class EchoServerHandler2 extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) {
        ...
        if (msg instanceof ByteBuffer) {
            ...
            System.out.println("handler2 received: " + in.toString(CharsetUtil.UTF_8));
        } else if (msg instanceof String) {
            ctx.write("handler2 收到消息--" + msg + System.lineSeparator());
            System.out.println("handler2 received: " + msg);
        }
